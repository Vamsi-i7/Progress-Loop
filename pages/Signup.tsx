...
const Signup: React.FC = () => {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Mock Signup -> Login
      login(name || 'New Student', email || 'student@progressloop.app');
      navigate('/dashboard');
    }, 1500);
  };
  ...
  const handleGoogleSignup = () => {
    ...
    setTimeout(() => {
      login('Google Student', 'google.student@gmail.com');
      navigate('/dashboard');
    }, 1500);
  };
      ...
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2rem] p-8 md:p-12 shadow-2xl border border-slate-100 dark:border-slate-800 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all mb-6 relative overflow-hidden"
          >
            {isLoading ? (
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-slate-900 px-2 text-slate-400">Or register with email</span>
            </div>
          </div>
